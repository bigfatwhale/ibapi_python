...
public:
    ...
    {
        boost::python::class_<CodeMsgPair>("CodeMsgPair", boost::python::init<int, std::string>() )
            .def( "code", &CodeMsgPair::code )
            .def( "msg",  &CodeMsgPair::msg, boost::python::return_value_policy<boost::python::copy_const_reference>()  )
        ;
    }
