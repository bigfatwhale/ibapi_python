...
void OperatorCondition::export_to_python()
{

    class_<OperatorCondition, bases<OrderCondition>, OperatorCondition, boost::noncopyable >("OperatorCondition", no_init)
        .add_property("isMore", 
                      static_cast<bool (OperatorCondition::*)(void) >(&OperatorCondition::isMore), 
                      static_cast<void (OperatorCondition::*)(bool) >(&OperatorCondition::isMore) )
        .def("toString", &OperatorCondition::toString )
    ;
